...
var _FontAwesomeIconsCommand = __webpack_require__(/*! ./FontAwesomeIconsCommand */ "./src/FontAwesomeIconsCommand.js");

var _FontAwesomeIconsCommand2 = _interopRequireDefault(_FontAwesomeIconsCommand);
...
/***/ "./src/FontAwesomeIconsCommand.js":
/*!****************************************!*\
  !*** ./src/FontAwesomeIconsCommand.js ***!
  \****************************************/
/*! no static exports found */
...
var FontAwesomeIconsCommand = function (_Command) {
     ...
     */
    function FontAwesomeIconsCommand(editor, attributeKey) {
        _classCallCheck(this, FontAwesomeIconsCommand);
         ...
         * @member {String}
         */
        var _this = _possibleConstructorReturn(this, (FontAwesomeIconsCommand.__proto__ || Object.getPrototypeOf(FontAwesomeIconsCommand)).call(this, editor));
    ...
    _createClass(FontAwesomeIconsCommand, [{
        key: 'refresh',
    ...
    return FontAwesomeIconsCommand;
}(_ckeditor5Exports.Command);

exports.default = FontAwesomeIconsCommand;
...
/***/ "./src/components/FontAwesomeIconsSelector.js":
/*!****************************************************!*\
  !*** ./src/components/FontAwesomeIconsSelector.js ***!
  \****************************************************/
/*! no static exports found */
...
var FontAwesomeIconsSelector = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    ...
    _inherits(FontAwesomeIconsSelector, _PureComponent);

    function FontAwesomeIconsSelector() {
        var _ref;

        _classCallCheck(this, FontAwesomeIconsSelector);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        var _this = _possibleConstructorReturn(this, (_ref = FontAwesomeIconsSelector.__proto__ || Object.getPrototypeOf(FontAwesomeIconsSelector)).call.apply(_ref, [this].concat(args)));

        _this.handleOnSelect = _this.handleOnSelect.bind(_this);
        return _this;
    }

    _createClass(FontAwesomeIconsSelector, [{
        key: 'render',
        value: function render() {
            ...
            var currentValue = this.props.formattingUnderCursor['fontAwesomeIconsSelector.js:' + this.props.presetIdentifier];
        ...
        value: function handleOnSelect(optionIdentifier) {
            CkEditorApi.executeCommand('fontAwesomeIconsSelector.js:' + this.props.presetIdentifier, { value: optionIdentifier });
        }
    }]);

    return FontAwesomeIconsSelector;
...
exports.default = FontAwesomeIconsSelector;
...
var _FontAwesomeIcons = __webpack_require__(/*! ./FontAwesomeIcons */ "./src/FontAwesomeIcons.js");

var _FontAwesomeIcons2 = _interopRequireDefault(_FontAwesomeIcons);

var _FontAwesomeIconsSelector = __webpack_require__(/*! ./components/FontAwesomeIconsSelector */ "./src/components/FontAwesomeIconsSelector.js");

var _FontAwesomeIconsSelector2 = _interopRequireDefault(_FontAwesomeIconsSelector);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('NeosRulez.CkFontAwesome:FontAwesomeIcons', {}, function (globalRegistry, _ref) {
    ...
    if (fontAwesomeIconConfiguration) {
        ...
        Object.keys(fontAwesomeIconConfiguration.presets).forEach(function (presetIdentifier) {

            var fontAwesomeIconPresetConfiguration = fontAwesomeIconConfiguration.presets[presetIdentifier];
