...
export default class FontAwesomeIconsSelector extends PureComponent {
    static propTypes = {
        // from outside props
    ...
    render() {
        ...
        const currentValue = this.props.formattingUnderCursor[`fontAwesomeIconsSelector.js:${this.props.presetIdentifier}`];
    ...
    handleOnSelect(optionIdentifier) {
        CkEditorApi.executeCommand(
            `fontAwesomeIconsSelector.js:${this.props.presetIdentifier}`,
            { value: optionIdentifier }
        );
    }
}
